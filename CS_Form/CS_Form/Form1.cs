...
,        };
            ...
            for (A = 0; A < 10; A++) 
            {
                _testButton [A] = new TestButton(this, strs[A], B, 0, 50, 50);
                Controls.Add(_testButton[A]);
                B = B + 50;
            }
            ...
            _textBox = new TestTextBox(this,"テキストボックスです", 110, 400, 500, 200);
